...
let musicIndex = Math.floor((Math.min(0) * allMusic.length) + 1);
isMusicPaused = true;
...
function calcmed() {
  var media = (n1.valueAsNumber + n2.valueAsNumber + n3.valueAsNumber)/3 ;

resposta.textContent = media

if(media >= 6){
  return resultado.textContent ="Aprovado"
}else{
  return resultado.textContent ="Reprovado"
}
